...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO products (name, price, description, image, images, category) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->execute([
        $name,
        $price,
        $description,
...
<head>
    ...
    <title>Agregar Producto - Bit-House</title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark border-right" id="sidebar-wrapper" style="width: 250px;">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="add_product.php" class="list-group-item list-group-item-action bg-dark text-white active"><i class="fas fa-plus-circle me-2"></i>Agregar Producto</a>
        ...
        <div id="page-content-wrapper" class="flex-grow-1">
            ...
            <div class="container-fluid p-4">
                <h1 class="mt-4 mb-4">Agregar Nuevo Producto</h1>
